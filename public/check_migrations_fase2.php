...
echo "<h1>Verificação de Migrations da Fase 2</h1>";
...
// Verificar tabelas da Fase 2
echo "<h2>Tabelas da Fase 2:</h2>";
$tables = [
    'home_category_pills' => '027_create_home_category_pills_table',
    'home_category_sections' => '028_create_home_category_sections_table',
    'banners' => '029_create_banners_table',
    'newsletter_inscricoes' => '030_create_newsletter_inscricoes_table',
];

echo "<table border='1' cellpadding='10'>";
echo "<tr><th>Tabela</th><th>Migration</th><th>Status</th><th>Registros</th></tr>";
...
if (!empty($pending)) {
    echo "<h2>Ação:</h2>";
    echo "<p><a href='?run_migrations=1' style='background: #4CAF50; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px;'>Executar Migrations Pendentes</a></p>";
}
...
if (isset($_GET['run_migrations'])) {
    ...
    echo "<p><a href='?' style='background: #2196F3; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px;'>Atualizar Página</a></p>";
}

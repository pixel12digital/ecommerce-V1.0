        ...
        <div class="info-section">
            ...
            <div class="form-group">
                ...
                <textarea name="informacoes_adicionais" rows="6" 
                          placeholder="Especificações técnicas e informações complementares que serão exibidas na aba 'Informações Adicionais' da página do produto"><?= htmlspecialchars($formData['informacoes_adicionais'] ?? '') ?></textarea>
                <small style="color: #666; font-size: 0.875rem; display: block; margin-top: 0.25rem;">
